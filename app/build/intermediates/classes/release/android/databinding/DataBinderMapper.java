...
class DataBinderMapper {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
            ...
            case com.tixon.timemanagement.R.layout.incomes_expenses_item:
                return com.tixon.timemanagement.databinding.IncomesExpensesItemBinding.bind(view, bindingComponent);
    ...
    int getLayoutId(String tag) {
        ...
        switch(code) {
            ...
            case 423753077:
                ...
                break;
            case 734253422:
                if(tag.equals("layout/incomes_expenses_item_0"))
                    return com.tixon.timemanagement.R.layout.incomes_expenses_item;
                break;
            case -665403056:
